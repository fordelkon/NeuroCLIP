...
#
# Usage:
#   bash scripts/macos/unzip.sh [eeg_zip_dir] [image_zip_dir] [hydra_overrides...]
#
# Examples:
#   bash scripts/macos/unzip.sh
#   bash scripts/macos/unzip.sh /zips/eeg /zips/img
#   bash scripts/macos/unzip.sh /zips/eeg /zips/img paths.thingseeg2_raw_dir=/data/eeg paths.thingseeg2_img_dir=/data/img
