# Usage:
#   .\scripts\windows\train.ps1 <subject_id> <model> <k_fold> <fold_idx> [hydra_overrides...]
#
# Description:
...
#
# Examples:
#   .\scripts\windows\train.ps1 sub-01 flatnet 5 0
#   .\scripts\windows\train.ps1 sub-02 nice 10 1
#   .\scripts\windows\train.ps1 sub-03 atms 5 0 trainer.max_epochs=100
...
$RunDir = "logs/train/runs/${Model}/${Model}_k${KFold}_fold${FoldIdx}_${SubjectId}"
